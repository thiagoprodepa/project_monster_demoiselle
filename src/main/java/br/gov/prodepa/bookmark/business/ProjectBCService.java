...
import br.gov.prodepa.bookmark.rest.Cancelled;
import br.gov.prodepa.bookmark.rest.Created;
 ...
 */
@Stateless
public class ProjectBCService extends BaseEntityService<Bookmark> {


    @Inject @Created
    private Event<Bookmark> newBookingEvent;
    
    @Inject @Cancelled
    private Event<Bookmark> cancelledBookingEvent;
    
    public ProjectBCService() {
